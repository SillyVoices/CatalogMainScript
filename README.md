...
This is my second attempt at making an Catalog Heaven Admin script lol, the first one I made is made with AI so I do not understand the script is doing so I decided remake from scratch. This script is very much of an improvement now as you can now call "me" or "others" in the targetplayer argument and have more commands. It is horrible to vibe code as as it feels like debugging with blindfolds and also you have to pray to the ai gods to give you a good working script, and the worst of all, the ai could forget the some parts of script generating garbage that doesn't work, but I learned alot of lua from it. If you judge my script by its varible name and instantly complain its ai, then how about you change it to the varible you like.
